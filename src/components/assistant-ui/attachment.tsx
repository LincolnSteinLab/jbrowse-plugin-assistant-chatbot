  ...
  const typeLabel = useAttachment(a => {
    ...
    switch (type) {
      ...
      case 'file':
        return 'File'
      default:
        throw new Error(`Unknown attachment type: ${a.type}`)
    }
  })
  ...
  return (
    <ComposerPrimitive.AddAttachment asChild>
      <TooltipIconButton
        ...
        // Disable & hide attachments button until we implement an adapter:
        disabled
        aria-hidden="true"
        className="aui-composer-add-attachment size-[34px] rounded-full p-1 text-xs font-semibold pointer-events-none"
      >
