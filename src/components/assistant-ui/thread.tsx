...
import { ReasoningMessagePart } from './custom/ReasoningMessagePart'
...
const ThreadWelcomeSuggestions: FC = () => {
  return (
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 @md:grid-cols-2">
      {[
        {
          title: 'How do I use JBrowse?',
          label: '',
          action: 'How do I use JBrowse?',
        },
        {
          title: 'Take me to BRCA1',
          label: '',
          action: 'Take me to BRCA1',
        },
    ...
    <div className="aui-composer-wrapper sticky bottom-0 mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 overflow-visible rounded-t-3xl bg-background pb-4 md:pb-6">
      ...
      <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col rounded-3xl border border-border bg-muted px-1 pt-2 shadow-[0_9px_9px_0px_rgba(0,0,0,0.01),0_2px_5px_0px_rgba(0,0,0,0.06)] dark:border-muted-foreground/15">
        ...
        <ComposerPrimitive.Input
          ...
          className="aui-composer-input max-h-32 min-h-8 w-full resize-none bg-transparent px-3.5 py-1.5 text-base outline-none placeholder:text-muted-foreground focus:outline-primary"
          rows={1}
  ...
  return (
    <div className="aui-edit-composer-wrapper mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 px-2 first:mt-4">
      <ComposerPrimitive.Root className="aui-edit-composer-root ml-auto flex w-full max-w-7/8 flex-col rounded-xl bg-muted">
        <ComposerPrimitive.Input className="aui-edit-composer-input flex min-h-[60px] w-full resize-none bg-transparent p-4 text-foreground outline-none" />
